...
const ProductItem = (props) => {
  ...
  const onAddProduct = (elemento) => {
    if (allProducts.find((item) => item.productID === elemento.productID)) {
      const products = allProducts.map((item) =>
        item.productID === elemento.productID
        ...
        <div className="divImagen">
          ...
          <Card.Img
            src={`${
              isActive
                ? image
                : "https://img.freepik.com/free-vector/404-error-template-flat-style_23-2147759636.jpg?w=826&t=st=1675871123~exp=1675871723~hmac=d506aee3005de3475235f0ac680d1a69430d9266eea5a2630e9509cfb5358cbd"
            }`}
